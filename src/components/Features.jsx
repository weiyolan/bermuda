...
function Feature({ className, title, subTitle, text, myKey }) {
    ...
    myTitleRef?.current !== undefined &&
      ctx.add(() => {
        let tl1 = gsap.timeline()
          ...
          .to(myRef.current, {
            borderColor: active ? '#6E4221FF' : '#6E422100',
            backgroundColor: hovering ? '#BD915919' : active ? '#BD915909' : '#BD915900',
            boxShadow: active ? '0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)' : 'none',
            duration: 0.5,
            ease: 'expo.out',
          }, 0)
  ...
  return (
    <div
      ...
      tabIndex='0'
      className={`relative font-raj font-medium flex flex-1 flex-col  focus-within:backdrop-blur-md hover:backdrop-blur-md border-[#6E422100] items-center rounded-xl pt-4 pb-2 cursor-pointer gap-4 ${className}`}>
      ...
      <p ref={myText} className="absolute bottom-[34%] translate-y-1/2 w-full px-4 text-center opacity-0 invisible ">
        {`${text}`}
      </p>
